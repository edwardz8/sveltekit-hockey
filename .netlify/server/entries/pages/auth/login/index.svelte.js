...
const css = {
  code: ".error.svelte-hikaqr{color:tomato}",
  map: null
};
...
const Login = (0, import_index_67075ed5.c)(($$result, $$props, $$bindings, slots) => {
  ...
  ${error ? `<p class="${"error svelte-hikaqr"}">${(0, import_index_67075ed5.e)(error)}</p>` : ``}
